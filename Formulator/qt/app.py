...
from qt.scripts.manual import manual_script
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.manual_widget = ManualAttrWidget()
        self.detail_widget.addTab(self.manual_widget, "手动属性")
        ...
        manual = manual_script(self.manual_widget)
        ...
        dashboard_script(parser, self.dashboard_widget,
                         talents, recipes, equipments, manual, consumables, bonuses)
